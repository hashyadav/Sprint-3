...
import {
  ...
  REGISTER_SUCCESS,
  REGISTER_FAILURE,
  GET_PROFILE_REQUEST,  // Corrected typo here
  GET_PROFILE_SUCCESS,
  GET_PROFILE_FAILURE,
  LOGOUT,
  UPDATE_USER_REQUEST,
  UPDATE_USER_FAILURE,
  UPDATE_USER_SUCCESS,
  FIND_USER_BY_ID_FAILURE, // Corrected typo here
...
const authReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case GET_PROFILE_REQUEST: // Corrected typo here
    ...
    case FIND_USER_BY_ID_FAILURE: // Corrected typo here
