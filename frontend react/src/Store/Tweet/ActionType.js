...
export const TWEET_RESTORE_REQUEST = "TWEET_RESTORE_REQUEST";
export const TWEET_RESTORE_SUCCESS = "TWEET_RESTORE_SUCCESS";
export const TWEET_RESTORE_FAILURE = "TWEET_RESTORE_FAILURE";
...
export const FETCH_MOST_LIKED_TWEETS_REQUEST = "FETCH_MOST_LIKED_TWEETS_REQUEST";
export const FETCH_MOST_LIKED_TWEETS_SUCCESS = "FETCH_MOST_LIKED_TWEETS_SUCCESS";
export const FETCH_MOST_LIKED_TWEETS_FAILURE = "FETCH_MOST_LIKED_TWEETS_FAILURE";
